...
const CABIN_MAP = { "Business":"business", "Première":"first" };
...
export default function ICanFly() {
  ...
  const [booking,   setBooking]   = useState("form");
        ...
        <div className="search-panel">
          ...
          <div className="sp-fields">
            ...
            <div className="sf" style={{position:"relative"}}>
              ...
              <span className="sf-val" style={{fontSize:14}}>
          ...
          {status==="done" && (
            <>
              ...
              {sorted.map((f,i) => {
                ...
                return (
                  <div key={f.id} className={`fcard ${isCheap?"fcard-best":""}`} style={{animationDelay:`${i*0.06}s`}}>
